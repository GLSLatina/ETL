OUTPUT TO /u/users/t99/openedge/scripts/tmp/arrivi_domani.csv.
FOR EACH zabolle WHERE zabolle.za-data > DATA_DA_SOSTITUIRE AND zabolle.za-cdata = ? AND zabolle.za-tsped <= 13 NO-LOCK:
